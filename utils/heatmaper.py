...
class Heatmaper(object):
    ...
    def gen_heatmap(self, image_file):
        ...
        """
        base_data_path = '/media/dasya/3b6c80d6-7b4b-4135-ada5-ca8ad1d83e9b/Datasets/CheXpert-v1.0-small'
        image_file = os.path.join(base_data_path, image_file.split('CheXpert-v1.0/')[1])
